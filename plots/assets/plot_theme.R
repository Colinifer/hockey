...
theme_cw_dark <-  theme(
  ...
  axis.title = element_text(family = "Chivo", size = 8),
  axis.title.y = element_text(angle = 90, vjust = 0.5),
  axis.text = element_text(size = 7, color = color_cw['white']),
  plot.title = element_text(family = "Chivo", size = 14),
...
theme_cw_light <-  theme(
  ...
  axis.ticks.length = unit(2.75, 'pt'),
  axis.title = element_text(family = "Chivo", size = 8, color = color_cw['dark_grey']),
  axis.title.y = element_text(angle = 90, vjust = 0.5),
